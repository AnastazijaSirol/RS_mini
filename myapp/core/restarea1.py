...
async def run_restarea1_simulation():
    ...
    while True:
        ...
        for vehicle in entrances:
            ...
            print(f"[RESTAREA1] {vehicle_id} sa ulaza PULA staje u {stop.timestamp_entrance}")
        ...
        for vehicle in exits:
            ...
            rest_exit_time = t_exit - timedelta(
            ...
            print(f"[RESTAREA1] {vehicle_id} (prije PULA-EXIT) staje u {stop.timestamp_entrance}")
